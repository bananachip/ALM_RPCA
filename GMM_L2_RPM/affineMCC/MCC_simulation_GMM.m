...
% MData = textread('fish_X.txt');
% DData = textread('fish_Y.txt');
% MData = textread('fish_X_nohead.txt');
% DData = textread('fish_Y_notail.txt');
...
load 'MData.mat',MData;
load 'DData.mat',DData
...
AC0 =[
   ...
   -0.04    0.89    0.09
         0         0    1.0000]
%AC0 = [1 0 0; 0 1 0; 0 0 1]
%AC0 = [.8 .2 -.3;.3 .8 .02; 0 0 1];
AC0 = [0.75 .1 0;0.25 0.85 0; -0.0 0 1]
...
figure
DisplayPoints2D(MData,DData);
figure
DisplayPoints2D(TData,DData);

disp(['误差：', num2str(norm(A - [.8 .2 -.3; .3 .8 .02; 0 0 1]))])
